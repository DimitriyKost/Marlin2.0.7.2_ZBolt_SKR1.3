...
#define STRING_CONFIG_H_AUTHOR "(Dimkos Z-Bolt+ SKR1.3 config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Z-Bolt+ v1.2"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 73.5
  #define DEFAULT_bedKi 14.22
  #define DEFAULT_bedKd 253
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 144 }
